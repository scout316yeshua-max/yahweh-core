...
import { SanctuaryGateway } from '@antigravity/client-core';
import { ScoutLensEngine } from 'cloudflare/angels';

export async function igniteGenesisRecord() {
  ...
  for (const artifact of artifacts) {
    ...
    await ScoutLensEngine.indexArchiveBlindly(textBuffer, artifact.tags);
  }
