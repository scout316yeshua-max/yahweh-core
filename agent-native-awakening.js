...
async function awakenAgentNativeCore() {
    ...
    const archiveLake = await angels_1.R2DataCatalog.mountIcebergTable({
    ...
    const relationalCore = await heaven_compute_1.FirebaseSQLConnect.initialize({
        sync: "REALTIME",
    ...
    const archiveCurator = new ai_studio_1.GeminiAgent({
        model: "gemini-3.0-pro-preview",
        workspace: antigravity_1.GoogleAntigravity.currentWorkspace,
    ...
    archiveCurator.onNewData(async (historicalEvent) => {
